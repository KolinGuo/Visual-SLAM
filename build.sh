...
cmake -DBUILD_PYTHON3=ON \
        ...
        -DORBSLAM2_LIBRARY=/slamdoom/libs/orbslam2/lib/libORB_SLAM2.so \
        -DBG2O_LIBRARY=/slamdoom/libs/orbslam2/Thirdparty/g2o/lib/libg2o.so \
        -DDBoW2_LIBRARY=/slamdoom/libs/orbslam2/Thirdparty/DBoW2/lib/libDBoW2.so \
        .
